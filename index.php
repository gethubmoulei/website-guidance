...
<body>
    ...
    <div class="list closed">
        <ul>
          <!------>
            <li class="title"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-shipin"></use></svg> 在线影视</li>
            ...
            <li><a rel="nofollow" href="https://www.netflix.com/" target="_blank"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-netflix"></use></svg>Netflix</a></li>
            ...
            <li><a rel="nofollow" href="https://www.nfyingshi.com/" title="国产盗版Netflix\,需会员" target="_blank"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-netflix"></use></svg>奈菲影视</a></li>
          <!------> 
            ...
            <li><a rel="nofollow" href="https://outlook.live.com/mail/" target="_blank"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-windows"></use></svg>Outlook</a></li>
          ...
          <!------>
            ...
            <li><a rel="nofollow" href="http://mobile.pinduoduo.com/" target="_blank"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-99"></use></svg>拼多多</a></li>
